...
function askAboutClub(question) {
    result = teams.map((team) => {
        if (
            question == "manager" ||
            question == "bosh-murabiy" ||
            question == "главный-тренер"
        ) {
            return {
                idNumber: team.id,
                clubName: team.name,
        ...
        if (
            ...
            return {
                ...
                topScorergoals: team.top_scorer.goals,
            };
        }
        if (
            question == "stadium" ||
        ...
        if (
            ...
            return {
                idNumber: team.id,
                clubName: team.name,
                clubTriumphs: team.trophies,
            };
        }
        if (question == "city" || question == "shahar" || question == "город") {
            return {
                idNumber: team.id,
                clubName: team.name,
                clubCity: team.city,
        ...
        if (
            ...
            return {
                idNumber: team.id,
                clubName: team.name,
                clubHistory: team.history,
                clubFounded: team.founded,
                clubColor: team.colors,
                clubOwner: team.owner,
            };
        } else {
            return {
                team,
...
askAboutClub(prompt(`What do you want to know?`));
console.log(result);